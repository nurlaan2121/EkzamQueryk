...
alter table agencyes add column id serial primary key ;

create type gender as enum ('Male','Female');

create type family_status as enum ('Single','Married','Divorced','Widow','Seperated','Other');
...
create table rent_infos(id serial primary key ,
                        owner_id int references owners(id),
                        customer_id int references  customers(id),
                        agency_id int references agencyes(id),
                        house_id int references houses(id));


alter table agencyes alter column name set not null;

alter table agencyes add constraint phone_number check (phone_number like '___________');
...
alter table rent_infos add column check_in date check (check_in > current_date);

alter table  rent_infos add column check_out date check (check_out > rent_infos.check_in);
...
alter table agencyes add column phone_number varchar check (phone_number like '_____________' and phone_number like '+996%');

insert into agencyes (name, phone_number, address_id) values ('House_kg', '+996700919191', 1);
insert into agencyes (name, phone_number, address_id) values ('Apartment Agency', '+996550123456', 2);
insert into agencyes (name, phone_number, address_id) values ('Rent Agency', '+996999098765', 3);
insert into agencyes (name, phone_number, address_id) values ('Comfort House', '+996500789098', 4);
insert into agencyes (name, phone_number, address_id) values ('My House', '+996086123456', 5);
insert into agencyes (name, phone_number, address_id) values ('Sweet Home', '+996709123456', 6);
insert into agencyes (name, phone_number, address_id) values ('Kg_apartment', '+996700789876', 7);
insert into agencyes (name, phone_number, address_id) values ('Rent_Apartment', '+996700987654', 8);
insert into agencyes (name, phone_number, address_id) values ('Get House', '+996700987654', 9);
insert into agencyes (name, phone_number, address_id) values ('Flat_rent', '+996550418756', 10);
...
insert into rent_infos (owner_id, customer_id, agency_id, house_id, check_in, check_out) values (1, 1, 2, 1, '2021-10-12', '2021-10-27');
insert into rent_infos (owner_id, customer_id, agency_id, house_id, check_in, check_out) values (2, 2, 3, 5, '2021-01-19', '2022-11-13');
insert into rent_infos (owner_id, customer_id, agency_id, house_id, check_in, check_out) values (3, 3, 4, 3, '2021-12-12', '2022-03-24');
insert into rent_infos (owner_id, customer_id, agency_id, house_id, check_in, check_out) values (20, 4, 5, 4, '2021-01-27', '2021-08-31');
insert into rent_infos (owner_id, customer_id, agency_id, house_id, check_in, check_out) values (5, 5, 6, 2, '2022-07-05', '2023-01-16');
insert into rent_infos (owner_id, customer_id, agency_id, house_id, check_in, check_out) values (6, 6, 7, 6, '2021-01-22', '2021-08-30');
insert into rent_infos (owner_id, customer_id, agency_id, house_id, check_in, check_out) values (7, 7, 8, 7, '2019-08-08', '2022-02-04');
insert into rent_infos (owner_id, customer_id, agency_id, house_id, check_in, check_out) values (8, 8, 9, 8, '2021-04-06', '2021-05-21');
insert into rent_infos (owner_id, customer_id, agency_id, house_id, check_in, check_out) values (9, 9, 10, 9, '2020-11-07', '2022-07-05');
insert into rent_infos (owner_id, customer_id, agency_id, house_id, check_in, check_out) values (22, 10, 11, 10, '2022-03-18', '2023-01-10');
insert into rent_infos (owner_id, customer_id, agency_id, house_id, check_in, check_out) values (11, 11, 2, 11, '2018-02-03', '2021-02-04');
insert into rent_infos (owner_id, customer_id, agency_id, house_id, check_in, check_out) values (12, 12, 3, 12, '2021-12-09', '2023-01-08');
insert into rent_infos (owner_id, customer_id, agency_id, house_id, check_in, check_out) values (13, 13, 4, 13, '2021-03-15', '2022-10-13');
insert into rent_infos (owner_id, customer_id, agency_id, house_id, check_in, check_out) values (10, 14, 5, 14, '2022-04-22', '2022-06-16');
insert into rent_infos (owner_id, customer_id, agency_id, house_id, check_in, check_out) values (15, 15, 6, 15, '2020-08-27', '2021-08-05');
insert into rent_infos (owner_id, customer_id, agency_id, house_id, check_in, check_out) values (16, 16, 7, 16, '2019-04-27', '2020-12-03');
insert into rent_infos (owner_id, customer_id, agency_id, house_id, check_in, check_out) values (17, 17, 8, 17, '2021-01-01', '2021-12-31');
insert into rent_infos (owner_id, customer_id, agency_id, house_id, check_in, check_out) values (10, 18, 9, 18, '2020-05-24', '2021-02-20');
insert into rent_infos (owner_id, customer_id, agency_id, house_id, check_in, check_out) values (32, 19, 10, 19, '2019-09-27', '2020-07-31');
insert into rent_infos (owner_id, customer_id, agency_id, house_id, check_in, check_out) values (4, 20, 11, 20, '2021-12-21', '2022-06-20');
insert into rent_infos (owner_id, customer_id, agency_id, house_id, check_in, check_out) values (21, 21, 2, 21, '2021-12-09', '2023-01-01');
insert into rent_infos (owner_id, customer_id, agency_id, house_id, check_in, check_out) values (10, 22, 3, 22, '2022-01-20', '2022-08-05');
insert into rent_infos (owner_id, customer_id, agency_id, house_id, check_in, check_out) values (13, 23, 4, 23, '2020-12-03', '2021-04-22');
insert into rent_infos (owner_id, customer_id, agency_id, house_id, check_in, check_out) values (24, 24, 5, 24, '2022-12-26', '2023-01-16');
insert into rent_infos (owner_id, customer_id, agency_id, house_id, check_in, check_out) values (33, 25, 6, 25, '2020-02-07', '2021-08-19');
insert into rent_infos (owner_id, customer_id, agency_id, house_id, check_in, check_out) values (26, 26, 7, 26, '2019-09-10', '2021-09-19');
insert into rent_infos (owner_id, customer_id, agency_id, house_id, check_in, check_out) values (6, 27, 8, 27, '2021-05-02', '2021-12-21');
insert into rent_infos (owner_id, customer_id, agency_id, house_id, check_in, check_out) values (28, 28, 9, 28, '2022-01-16', '2022-12-13');
insert into rent_infos (owner_id, customer_id, agency_id, house_id, check_in, check_out) values (29, 29, 10, 29, '2020-11-09', '2021-05-04');
insert into rent_infos (owner_id, customer_id, agency_id, house_id, check_in, check_out) values (30, 30, 11, 30, '2022-05-08', '2022-12-29');


--1. Owner_лердин аттарынын арасынан эн коп символ камтыган owner_ди жана анын уйун(House) чыгар.
select first_name,houses.house_type,houses.price,houses.owner_id,houses.rating, max(length(first_name)) from owners join rent_infos on owners.id = rent_infos.owner_id join houses on rent_infos.house_id = houses.id group by first_name,houses.house_type,houses.price,houses.owner_id,houses.rating order by max(length(first_name)) desc limit 1;

-- 2. Уйлордун баалары 1500, 2000 дин аралыгында бар болсо true чыгар, жок болсо false чыгар.
select price from houses where price between 1500 and 2000 group by price;

-- 3. id_лери 5, 6, 7, 8, 9, 10 го барабар болгон адресстерди жана ал адрессте кайсы уйлор бар экенин чыгар.
select addresses.id, city, region, street,houses.id, house_type, price, rating, description, room, furniture, address_id, owner_id from addresses join houses on addresses.id = houses.address_id where addresses.id  in (5,6,7,8,9,10);

-- 4. Бардык уйлорду, уйдун ээсинин атын, клиенттин атын, агенттин атын чыгар.
select houses.id, houses.house_type, houses.price, houses.rating, houses.description, houses.room, houses.furniture, houses.address_id, houses.owner_id,owners.first_name,customers.first_name,agencyes.name from houses join rent_infos on houses.id = rent_infos.house_id join owners on rent_infos.owner_id = owners.id join agencyes on rent_infos.agency_id = agencyes.id join customers on rent_infos.customer_id = customers.id;
...
select * from houses join owners on houses.owner_id = owners.id order by houses.rating ;
select * from houses join owners on houses.owner_id = owners.id order by houses.rating desc ;
